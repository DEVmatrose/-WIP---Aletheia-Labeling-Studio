  ...
  <div class="queue-panel-with-tabs aletheia-panel h-full overflow-hidden flex flex-col">
    ...
    <div class="p-4 border-b border-gray-200 dark:border-gray-700">
      ...
      <div class="mt-2 text-sm text-gray-600 dark:text-gray-400">
        {{ stats.pending || 5 }} pending · {{ stats.completed || 6 }} completed
      </div>
...
const filters = computed(() => [
  { value: 'pending' as const, label: 'Pending', count: props.stats.pending || 5 },
  { value: 'completed' as const, label: 'Completed', count: props.stats.completed || 6 },
  { value: 'skipped' as const, label: 'Skipped', count: props.stats.skipped || 2 },
]);
